...
cm.pkg = require(path.resolve(process.cwd(), '../../package.tmpl.json'));
...
// Utils
// Run is deprecated, but cool to run tasks and their dependencies...
// https://github.com/gulpjs/gulp/issues/193
cm.run = function run() {
    gulp.start.apply(gulp, Array.prototype.slice.call(arguments, 0));
};
